...
function preload(){
  ...
  livesImage = loadImage("Images/Heart.jpg")
...
function setup(){
  ...
  Npc4 = createSprite(180,75,25,25)
  Npc4.addImage(Npc)
  Npc4.scale = 0.50
...
if (lives == 0){
  ...
  textSize(50)
  text("YOU LOST. BETTER LUCK NEXT TIME",600,400)
}
...
if (loadingBar1.width>=100){
  ...
  loadingBar1.visible = false;
  computer1.shapeColor="green";

}
if (loadingBar2.width>=100){

  loadingBar2.visible = false;
  computer2.shapeColor="green";

}
if (loadingBar3.width>=100){

  loadingBar3.visible = false;
  computer3.shapeColor="green";

}
if (loadingBar4.width>=100){

  loadingBar4.visible = false;
  computer4.shapeColor="green";

}

for(i = 1; i <= lives; i++){

  image(livesImage,50*i,10,50,50)

} 

if (loadingBar1.width>=100 && loadingBar2.width>=100 && loadingBar3.width>=100 && loadingBar4.width>=100){
